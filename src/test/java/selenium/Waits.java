...
public class Waits {
    ...
    public void waitImplicitly() {
        ...
        Wait wait = new WebDriverWait(driver,2000);
    ...
    public void progressBar() {
        ...
        FluentWait wait = new FluentWait(driver).pollingEvery(30, SECONDS).ignoring(NoSuchElementException.class);
        wait.until(ExpectedConditions.elementToBeClickable(By.id("wrwr")));
